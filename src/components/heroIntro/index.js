            ...
            <div className="container mx-auto flex px-5 py-16 items-center justify-center flex-col">
                <div className="text-center lg:w-2/3 w-full">
                    ...
                    <div className="sm:flex justify-center">
                        <button className="m-1 bg-zinc-900 hover:bg-grey text-grey-darkest font-bold py-3 px-6 rounded inline-flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" />
                            </svg>
                            <span className="ml-1">Lorem ipsum</span>
                        </button>
                        <button className="m-1 bg-black hover:bg-grey text-grey-darkest font-bold py-3 px-6 rounded inline-flex items-center">
